            ...
            <div class="body1">
                <div class="main">
                    ...
                    <header>
                        ...
                        <nav>
                            <ul id="top_nav">
								<li><a href="index.jsp"><img src="images/icon_1.gif" alt="index.jsp"></a></li>
                        ...
                        <nav>
                            <ul id="menu">
                                ...
                                <li ><a href="EventDetail.jsp">EventDetail</a></li>
                            ...
                            <div id="publishdetail">
                                <form id="eventForm" method ="post" action = "operate">
                                    ...
                                    <div class="formcolumn">
                                        ...
                                        <input type="text" name="loc" value="" size="20" />
                                    </div>
                                    ...
                                    <div class="formcolumn">
                                        ...
                                        <fieldset>
                                            ...
                                            <ul>
                                                <li><input type="radio" name="type" value="Sport"/>Sport</li>
                                                <li><input type="radio" name="type" value="Art"/>Art</li>
                                                <li><input type="radio" name="type" value="Music"/>Music</li>
                                                <li><input type="radio" name="type" value="Speech"/>Speech</li>
                                                <li><input type="radio" name="type" value="Fair"/>Fair</li>
                                                <li><input type="radio" name="type" value="Special Event"/>Special Event</li>
                                            </ul>
                                        </fieldset> 

                                        <label for="contact">Contact:</label>
                                        <input type="text" name="contact" value="" size="20" />

                                        <label for="dpt">Department:</label>
                                        <input type="text" name="dpt" value="" size="20" />
                                    </div>  

                                    <div class = "infobox">
                                        <p><br></p>
                                        <label for="info">More Info:</label>
                                        <textarea name="info" rows="8" cols="30"></textarea>
                                    </div>
